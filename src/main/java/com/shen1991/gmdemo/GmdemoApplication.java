...
import com.shen1991.gmdemo.repository.CustomerRepository;
...
@ComponentScan("com.shen1991.gmdemo.controller")
public class GmdemoApplication {

	private static final Logger log = LoggerFactory.getLogger(GmdemoApplication.class);
